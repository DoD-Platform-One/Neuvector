...
![Version: 2.6.3-bb.13](https://img.shields.io/badge/Version-2.6.3--bb.13-informational?style=flat-square) ![AppVersion: 5.2.2](https://img.shields.io/badge/AppVersion-5.2.2-informational?style=flat-square)
...
| global.azure.images.neuvector_csp_pod.digest | string | `nil` |  |
...
| global.aws.image.digest | string | `nil` |  |
...
| cve.adapter.certificate.secret | string | `nil` |  |
| cve.adapter.certificate.keyFile | string | `"tls.key"` |  |
| cve.adapter.certificate.pemFile | string | `"tls.pem"` |  |
...
| cve.adapter.internal.certificate.secret | string | `"neuvector-internal"` |  |
