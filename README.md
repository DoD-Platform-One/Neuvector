...
![Version: 1.9.1-bb.0](https://img.shields.io/badge/Version-1.9.1--bb.0-informational?style=flat-square) ![AppVersion: 4.4.4](https://img.shields.io/badge/AppVersion-4.4.4-informational?style=flat-square)
...
| controller.image.repository | string | `"platform-one/big-bang/apps/sandbox/neuvector/controller.preview"` |  |
...
| controller.federation.mastersvc.ingress.annotations."ingress.kubernetes.io/protocol" | string | `"https"` |  |
...
| controller.federation.managedsvc.ingress.annotations."ingress.kubernetes.io/protocol" | string | `"https"` |  |
...
| controller.ingress.annotations."ingress.kubernetes.io/protocol" | string | `"https"` |  |
...
| enforcer.image.repository | string | `"platform-one/big-bang/apps/sandbox/neuvector/enforcer.preview"` |  |
...
| manager.image.repository | string | `"platform-one/big-bang/apps/sandbox/neuvector/manager.preview"` |  |
...
| cve.updater.image.repository | string | `"platform-one/big-bang/apps/sandbox/neuvector/updater.preview"` |  |
...
| cve.scanner.image.repository | string | `"platform-one/big-bang/apps/sandbox/neuvector/scanner.preview"` |  |
