...
![Version: 2.8.7-bb.0](https://img.shields.io/badge/Version-2.8.7--bb.0-informational?style=flat-square) ![AppVersion: 5.4.5](https://img.shields.io/badge/AppVersion-5.4.5-informational?style=flat-square) ![Maintenance Track: bb_integrated](https://img.shields.io/badge/Maintenance_Track-bb_integrated-green?style=flat-square)
...
| cve.adapter.image.registry | string | `"registry1.dso.mil"` |  |
| cve.adapter.image.repository | string | `"ironbank/opensource/neuvector/registry-adapter"` |  |
| cve.adapter.image.tag | string | `"v0.1.8"` |  |
